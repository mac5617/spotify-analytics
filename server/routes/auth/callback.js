...
router.get("/", (req, res) => {
  ...
  const REDIRECT_URI = "https://umd-spotify-backend.herokuapp.com/callback";
  ...
  axios({
    ...
    .then((response) => {
      if (response.status === 200) {
        ...
        //res.send(response);
        res.redirect(
        `https://mac5617.github.io/Group101-01-Final-Project-Spotify-Analytics/pages/graph_folder/graph`
        );
